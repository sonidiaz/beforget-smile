  ...
  <Fragment>
    ...
    <div class="row justify-content-md-center mt-5 mb-5">
      ...
      <div class="row justify-content-md-center mt-5">
        <div class="col col-lg-6">
          <span class="bfg-text-1 bfg-text-light"> <strong>¿Quieres ser uno más?</strong> </span>
        </div>
      </div>
      <div class="row justify-content-md-center mt-3">
        <div class="col col-lg-8">
          <span class="bfg-text-2">Ven a la próxima BeForGet Talk y preséntate a Comunidad</span>
        </div>
      </div>
      <div class="row justify-content-md-center mt-5">
        <div class="col-lg-12">
          <a class="btn btn-primary bfg-primary" href="https://www.beforget.com/talks">Inscríbete y conócenos</a>
        </div>
      </div>
  </Fragment>
</template>
